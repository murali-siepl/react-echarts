...
class WaterWave extends PureComponent {
  ...
  componentDidMount() {
    ...
    window.addEventListener(
      'resize',
      () => {
// All callbacks registered with raf are managed by the browser and executed together at an appropriate time.
// When the page is not visible, for example, when the current tab is switched or hidden in the background, raf will pause to reduce terminal overhead.
